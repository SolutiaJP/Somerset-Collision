...
namespace SeedApp.WebApi.Tests
{
	[TestClass]
	public class CodeGenerationTests
	{
		...
		public CodeGenerationTests()
		{
			...
			databaseName = @"SeedApp";
			projectRootPath = @"C:\\ProjectStoreGit\\Solutia-SeedApp\\Application\\Server\\SeedApp.Service\\SeedApp.";
			projectName = @"SeedApp";
			connectionString = @"Data Source=localhost;Initial Catalog=SeedApp;Integrated Security=True";
			nameSpace = @"SeedApp";
		...
		public void TestGetStoredProcCodeGenerationMetaDataByStoredProcName()
		{
			...
			const string assemblyPath = @"C:\ProjectStoreGit\Solutia-SeedApp\Application\Server\SeedApp.Service\SeedApp.DataContracts\bin\Debug\SeedApp.DataContracts.dll";
